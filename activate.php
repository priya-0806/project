...
<nav class="navbar navbar-expand-lg navbar-primary bg-primary">
    ...
    <div>
    <a href="activers.php" ><input type="submit" value="Activers" class="btn btn-success" name="" id=""></a></div><br>
    <div align="right">
    <a href="inactivers.php" ><input type="submit" value="In Activers" class="btn btn-secondary h11" name="" id=""></a></div><br>
<?php
     ...
     if($res=mysqli_query($con,$sql)){
       if(mysqli_num_rows($res)>0){
          ...
          while($row=mysqli_fetch_array($res)){
              ...
              echo "<td> <a href='approve.php?id=$id'><button> Active</button></a> 
              <a href='cancel.php?id=$id'><button>In Active </button></a></td>";
              echo "</tr>";
              $i=$i+1;
       }
      echo "</table>";

...
include 'connection.php';
    ...
    $var=$id;
        //echo $id;
    $sql="SELECT description,date FROM holiday where holidayid='$id'";
...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        ...
        <div class="container">
            <form class="row g-3" action="holidaysedit1.php" method="post">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Enter your description" name="n1" value="<?php echo $des?>" required/>
                </div>
                
                <div class="col-md-6">
                    <label for="date" class="form-label">Date:</label>
                    <input type="date" class="form-control" id=" "  name="n2"value="<?php echo  $date?>" required/>
                </div>

...
include 'connection.php';
    ?>
    <?php
    $sql="SELECT*FROM training INNER JOIN customer ON training.customerid=customer.customerid INNER JOIN trainer ON training.trainerid=trainer.trainerid INNER JOIN package ON training.packageid=package.packageid;";
            ...
            while($row=mysqli_fetch_array($res)){
              ...
              $id=$row['trainingid'];
               ...
               echo "<td>" .$row['mobilenumber']."</td>";
                ...
                if($_SESSION['srole']=='admin'){
                  echo "<td> <a href='trainingdlt.php?id=".$row['trainingid']."' onclick='return confirm(\"Do you want to delete?\")'><i class=\"fa fa-trash-o\"></i></a> 
                      </td>"; 
                  }else{
                    echo ""; 
                  }

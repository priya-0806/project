...
<nav class="navbar navbar-expand-lg navbar-primary bg-primary">
    ...
    <a href="pkginsert.php" ><input type="submit" value="INSERT THE PACKAGES" class="btn btn-dark" name="" id=""> </a> 
    <div align="right">
          ...
          $i=1;
            while($row=mysqli_fetch_array($res)){
              ...
              $id=$row['packageid'];
                ...
                if($_SESSION['srole']=='admin'){
                echo "<td> <a href='pkgdlt.php?id=".$row['packageid']."' onclick='return confirm(\"Do you want to delete?\")'><i class=\"fa fa-trash-o\"></i></a> 
                     <a href='pkgedit.php?id=".$row['packageid']."'><i class=\"fa fa-wrench\"></i></a>
                     <a href='pkgview.php?id=".$row['packageid']."'><i class=\"fa fa-eye\"></i></i></a></td>"; 
                }else{
                  echo ""; 
                  header("location:packageuser.php");

...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        ...
        <div class="container">
            <form class="row g-3" action="custinsert1.php" method="post" name="myform">
                <div class="col-md-12">
                    <h1 class="h1" align="center" >NEW CUSTOMER </h1>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-6">
                    <button id="B1" type="submit" class="btn btn-primary" onclick='return validate()'>Create New Customer</button>
                </div>
            </form>

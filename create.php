...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
     ...
     <div class="container">
            <form class="row g-3" action="create1.php" method="post" name="myform">
                <div class="col-md-12">
                    <h1 class="h2" align="center">NEW USER </h1>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-6">
                    <button id="B1" type="submit" class="btn btn-primary" onclick='return validate()'>Create New User</button>
                </div>
            </form>

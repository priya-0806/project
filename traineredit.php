...
include 'connection.php';
    ...
    $var=$id;
        //echo $id;
    $sql="SELECT trainername,gender,dob,mobilenumber,address,city,state,pincode,yoe FROM trainer where trainerid='$id'";
...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        ...
        <div class="container">
            <form class="row g-3" action="traineredit1.php" method="post">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <label for="dropdown" class="form-label">Years of Experiences:</label>
                    <select name="n9" class="form-control" value="<?php echo  $yoe?>">
                        <option> Null </option>
